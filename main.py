...
from logic import TimelapseLogic, WatermarkLogic, PremiereRenamerLogic

ctk.set_appearance_mode("Dark")
ctk.set_default_color_theme("blue")


class PremiereRenamerFrame(ctk.CTkFrame):
    """Tab 3: Preparazione sequenze per Adobe Premiere Pro."""

    def __init__(self, master, **kwargs):
        super().__init__(master, **kwargs)
        self.logic = PremiereRenamerLogic()
        self.input_dir = ""
        self.output_dir = ""
        self._setup_ui()
    ...
    def _setup_ui(self):
        ...
        ctk.CTkLabel(
            self,
            text="Premiere Image Sequence Renamer",
...
class TimelapseApp(ctk.CTk):
    def __init__(self):
        ...
        self.tab_view.add("Premiere Renamer")
        ...
        self.renamer_frame = PremiereRenamerFrame(self.tab_view.tab("Premiere Renamer"))
